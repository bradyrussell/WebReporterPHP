...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form class="navbar-form" role="form" method="get" action="index.php">
                <button type="submit" class="btn btn-default">All Reports</button>
            </form>
        </div><!--/.navbar-collapse -->
    </div>
</nav>
...
<table class="table table-striped table-dark table-hover">
    ...
    $tickets = array_merge(GetReportsByManagerAndStatus(GetDBConnection(),$manager['username'], "open"), GetReportsByManagerAndStatus(GetDBConnection(),$manager['username'], "in_progress"), GetReportsByManagerAndStatus(GetDBConnection(),$manager['username'], "pending"));

    if($show_closed > 0){
        $tickets = array_merge($tickets, GetReportsByManagerAndStatus(GetDBConnection(),$manager['username'], "resolved"), GetReportsByManagerAndStatus(GetDBConnection(),$manager['username'], "cancelled"));
    }
